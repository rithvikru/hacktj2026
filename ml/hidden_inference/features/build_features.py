...
def load_label_priors() -> dict:
    """Load support_priors and container_priors from closed-set-labels.yaml."""
...
def build_candidates(
    ...
    """Build Candidate objects from scene graph nodes + observation history."""
    ...
    for node in candidate_nodes:
        ...
        # Distance score: closer to last-seen location = higher
...
def main() -> None:
    ...
    # Load room graph and extract scene_graph + observations
